...
public class AddressBook {
  ...
  //  private static final String COMMAND_ADD_EXAMPLE = COMMAND_ADD_WORD + " John Doe p/98765432 e/johnd@gmail.com";
    ...
    private static void echoUserCommand(String userCommand) {
        List<String>items = new ArrayList<String>();
        items.add("[Command entered:" + userCommand + "]");
    ...
    private static void processProgramArgs(String[] args) {
        if (args.length >= 2) {
            List<String>items = new ArrayList<String>();
            items.add(MESSAGE_INVALID_PROGRAM_ARGS);
            showToUser(items);
            exitProgram();
        }
    ...
    private static void setupGivenFileForStorage(String filePath) {
        ...
        if (!isValidFilePath(filePath)) {
            List<String>items = new ArrayList<String>();
            items.add(String.format(MESSAGE_INVALID_FILE));
            items.add(filePath);
            showToUser(items);
    ...
    private static void setupDefaultFileForStorage() {
        List<String>items = new ArrayList<String>();
        items.add(MESSAGE_USING_DEFAULT_FILE);
    ...
    private static String executeListAllPersonsInAddressBook() {
        ...
        for(int i=0;i<toBeDisplayed.size()-1;i++)
        {
            ...
            {
                String var1 = toBeDisplayed.get(i)[0];
                String var2 = toBeDisplayed.get(j)[0];
                if(var1.compareTo(var2)>0)
                {
                    Collections.swap(toBeDisplayed,i,j);
                }
            }
        }
    ...
    */
    ...
    private static void createFileIfMissing(String filePath) {
        ...
        List<String>items = new ArrayList<String>();
        items.add(String.format(MESSAGE_ERROR_MISSING_STORAGE_FILE));
        items.add(filePath);
        ...
        try {
            ...
            items.add(String.format(MESSAGE_STORAGE_FILE_CREATED));
            items.add(filePath);
            ...
            items.add(String.format(MESSAGE_ERROR_CREATING_STORAGE_FILE));
            items.add(filePath);
    ...
    private static ArrayList<String[]> loadPersonsFromFile(String filePath) {
        ...
        if (!successfullyDecoded.isPresent()) {
            List<String>items = new ArrayList<String>();
            items.add(String.format(MESSAGE_INVALID_STORAGE_FILE_CONTENT));
            items.add(filePath);
    ...
    private static ArrayList<String> getLinesInFile(String filePath) {
        ...
        try {
            ...
            List<String>items = new ArrayList<String>();
            items.add(String.format(MESSAGE_ERROR_READING_FROM_FILE));
            items.add(filePath);
    ...
    private static void savePersonsToFile(ArrayList<String[]> persons, String filePath) {
        ...
        try {
            ...
            List<String>items = new ArrayList<String>();
            items.add(String.format(MESSAGE_ERROR_WRITING_TO_FILE));
            items.add(filePath);
    ...
    private static String getUsageInfoForAddCommand() {
        ...
        john.put(PERSON_PROPERTY_NUMBER,"98765432");
        String COMMAND_ADD_EXAMPLE = COMMAND_ADD_WORD +john.get(PERSON_PROPERTY_NAME)+" \\p"+ john.get(PERSON_PROPERTY_NUMBER)+
                " \\e"+john.get(PERSON_PROPERTY_EMAIL);
